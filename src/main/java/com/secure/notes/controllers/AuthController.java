...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest) {
        ...
        try {
            /*UsernamePasswordAuthenticationToken creates a token object with the provided username and password.
            This token is passed into Spring Security's AuthenticationManager.
            */
